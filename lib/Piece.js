...
// The size of a wall on the game board. Walls are always of size 1
...
class Wall extends Piece {
    ...
    use(spaces) {
        ...
        super.place(spaces);
        // Make sure this wall cannot be modified anymore.
        Object.freeze(this);

        // TODO: Implement logic for "placing" the wall on the board.
        return this;
    }
}
